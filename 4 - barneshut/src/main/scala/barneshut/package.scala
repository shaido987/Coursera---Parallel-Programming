...
package object barneshut {
  ...
  case class Fork(
    ...
    def insert(b: Body): Fork = b match {
	  case b if b.x > centerX && b.y > centerY => Fork(nw, ne, sw, se.insert(b))
	  case b if b.x > centerX                  => Fork(nw, ne.insert(b), sw, se)
	  case b if b.y > centerY                  => Fork(nw, ne, sw.insert(b), se)
	  case b                                   => Fork(nw.insert(b), ne, sw, se)
    }
  }
